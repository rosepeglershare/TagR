...
TagR is SHARE's R package for topic tagging using machine learning. Using predefined topics and a labelled data set, it allows the user to find the probability that a post belongs to a particular topic.
